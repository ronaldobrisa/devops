...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "debian" do |debian|
    ...
    debian.vm.network "private_network", type: "static", ip:"192.168.1.11"
  ...
  config.vm.define "almalinux" do |almalinux|
    ...
    almalinux.vm.network "private_network", type: "static", ip:"192.168.1.10"
  ...
  config.vm.define "windows" do |windows|
    ...
    windows.vm.network "private_network", type: "static", ip:"192.168.1.12"
